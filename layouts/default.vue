<template>
    <div>
        ...
        <link rel="stylesheet" media="all" href="//fonts.googleapis.com/css?family=Raleway:400">
        <link rel="stylesheet" media="all" href="//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
    </div>
</template>

<style lang="scss">
    // https://kuler.adobe.com/Sunrise-(subtle)-color-theme-1450987/
    ...
    @import "../public/stylesheets/_responsive.scss";
    ...
    *, *:before, *:after {
    ...
    html {
        font: 14px "Raleway", "Roboto", Arial, sans-serif;
    ...
    .nav {
        ...
        .menu {
            ...
            a, a:link, a:visited, a:active, a:hover {
                ...
                &.active {
                    background: rgba(darken($dark2, 20%), .5);
                    &:after {
                        display: block;
                    }
                    .icon-block {
    ...
    .content {
        ...
        .tool {
            ...
            & > * {
                ...
                margin: 0;
                display: block;
                border-bottom: 1px dashed $light3;
                &:last-child {
                    border-bottom: 0
                }
            }
        ...
        .random-tool {
            h3 {
                ...
                margin: 0 .5rem;
                padding: .5rem;
                border-bottom: 1px dashed $light2;
            }
